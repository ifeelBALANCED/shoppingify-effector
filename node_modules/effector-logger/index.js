...
var effector__namespace = /*#__PURE__*/_interopNamespace(effector);
...
const root = effector__namespace.createDomain(LOGGER_DOMAIN_NAME, {
  loc: {
...
Object.keys(effector).forEach(function (k) {
