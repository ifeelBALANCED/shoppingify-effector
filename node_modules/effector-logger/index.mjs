import * as effector from 'effector/effector.mjs';
import { is, createNode, step } from 'effector/effector.mjs';
export * from 'effector/effector.mjs';
import * as inspector from 'effector-inspector/index.mjs';
import debounce from 'just-debounce-it';
import isNode from 'detect-node';
import set from 'set-value';

var _effectorFileName$2 = "/src/lib.ts";
...
var _effectorFileName$1 = "/src/attach.ts";
const defaults = {
...
export { configure, createDomain, createEffect, createEvent, createStore };
