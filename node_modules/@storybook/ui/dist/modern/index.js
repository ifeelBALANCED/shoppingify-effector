 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ReactPropTypesSecret$3='SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED';var ReactPropTypesSecret_1=ReactPropTypesSecret$3;var has$6=Function.call.bind(Object.prototype.hasOwnProperty);/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var printWarning$1=function(){};if(process.env.NODE_ENV!=='production'){var ReactPropTypesSecret$2=ReactPropTypesSecret_1;var loggedTypeFailures={};var has$5=has$6;printWarning$1=function(text){var message='Warning: '+text;if(typeof console!=='undefined'){console.error(message);}try{// --- Welcome to debugging React ---
 ...
 * @private
 */function checkPropTypes$1(typeSpecs,values,location,componentName,getStack){if(process.env.NODE_ENV!=='production'){for(var typeSpecName in typeSpecs){if(has$5(typeSpecs,typeSpecName)){var error;// Prop type validation may throw. In case they do, we don't want to
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var ReactIs$1=reactIs$1.exports;var assign$1=objectAssign;var ReactPropTypesSecret$1=ReactPropTypesSecret_1;var has$4=has$6;var checkPropTypes=checkPropTypes_1;var printWarning=function(){};if(process.env.NODE_ENV!=='production'){printWarning=function(text){var message='Warning: '+text;if(typeof console!=='undefined'){console.error(message);}try{// --- Welcome to debugging React ---
// This error was thrown as a convenience so that you can use this stack
// to find the callsite that caused this warning to fire.
...
React$2.createElement(Pane$1,{key:index,index:index,active:active},item))));Panels.displayName='Panels';const PanelsContainer=styled.div({position:'fixed',top:0,left:0,width:'100vw'},({isFullscreen})=>({height:isFullscreen?'100vh':'calc(100% - 40px)'}));const Bar$1=styled.nav({position:'fixed',bottom:0,left:0,width:'100vw',height:40,display:'flex',boxShadow:'0 1px 5px 0 rgba(0, 0, 0, 0.1)','& > *':{flex:1}},({theme})=>({background:theme.barBg}));class Mobile extends Component{constructor(props){super(props);const{options}=props;this.state={active:options.isFullscreen?CANVAS:options.initialActive||SIDEBAR};}render(){const{Sidebar,Preview,Panel,Notifications,pages,viewMode,options,docsOnly}=this.props;const{active}=this.state;return React$2.createElement(Root$2,null,React$2.createElement(Notifications,{placement:{position:'fixed',bottom:60,left:20,right:20}}),React$2.createElement(Panels,{active:active,isFullscreen:options.isFullscreen},React$2.createElement(Sidebar,null),React$2.createElement("div",null,React$2.createElement("div",{hidden:!viewMode},React$2.createElement(Preview,{showToolbar:options.showToolbar,id:"main",viewMode:viewMode})),pages.map(({key,route:Route,render:Content})=>React$2.createElement(Route,{key:key},React$2.createElement(Content,null)))),React$2.createElement(Panel,{hidden:!viewMode})),!options.isFullscreen&&React$2.createElement(Bar$1,null,React$2.createElement(TabButton,{onClick:()=>this.setState({active:SIDEBAR}),active:active===SIDEBAR},"Sidebar"),React$2.createElement(TabButton,{onClick:()=>this.setState({active:CANVAS}),active:active===CANVAS},viewMode?'Canvas':null,pages.map(({key,route:Route})=>React$2.createElement(Route,{key:key},key))),viewMode&&!docsOnly?React$2.createElement(TabButton,{onClick:()=>this.setState({active:ADDONS}),active:active===ADDONS},"Addons"):null));}}/*! *****************************************************************************
...
if(window.store){_.conflict=window.store;}window.store=store;}})(commonjsGlobal,commonjsGlobal&&commonjsGlobal.define);})(store2);const store=store2.exports;/**
 ...
 */function objectToString$2(value){return nativeObjectToString.call(value);}var _objectToString=objectToString$2;var Symbol$1=_Symbol,getRawTag=_getRawTag,objectToString$1=_objectToString;/** `Object#toString` result references. */var nullTag='[object Null]',undefinedTag='[object Undefined]';/** Built-in value references. */var symToStringTag=Symbol$1?Symbol$1.toStringTag:undefined;/**
 * The base implementation of `getTag` without fallbacks for buggy environments.
 *
 * @private
 * @param {*} value The value to query.
 * @returns {string} Returns the `toStringTag`.
 */function baseGetTag$1(value){if(value==null){return value===undefined?undefinedTag:nullTag;}return symToStringTag&&symToStringTag in Object(value)?getRawTag(value):objectToString$1(value);}var _baseGetTag=baseGetTag$1;/**
 ...
 * _.isSymbol('abc');
 * // => false
 */function isSymbol$2(value){return typeof value=='symbol'||isObjectLike(value)&&baseGetTag(value)==symbolTag;}var isSymbol_1=isSymbol$2;var baseTrim=_baseTrim,isObject$2=isObject_1,isSymbol$1=isSymbol_1;/** Used as references for various `Number` constants. */var NAN=0/0;/** Used to detect bad signed hexadecimal string values. */var reIsBadHex=/^[-+]0x[0-9a-f]+$/i;/** Used to detect binary string values. */var reIsBinary=/^0b[01]+$/i;/** Used to detect octal string values. */var reIsOctal=/^0o[0-7]+$/i;/** Built-in method references without a dependency on `root`. */var freeParseInt=parseInt;/**
 ...
 * _.toNumber('3.2');
 * // => 3.2
 */function toNumber$1(value){if(typeof value=='number'){return value;}if(isSymbol$1(value)){return NAN;}if(isObject$2(value)){var other=typeof value.valueOf=='function'?value.valueOf():value;value=isObject$2(other)?other+'':other;}if(typeof value!='string'){return value===0?value:+value;}value=baseTrim(value);var isBinary=reIsBinary.test(value);return isBinary||reIsOctal.test(value)?freeParseInt(value.slice(2),isBinary?2:8):reIsBadHex.test(value)?NAN:+value;}var toNumber_1=toNumber$1;var isObject$1=isObject_1,now=now_1,toNumber=toNumber_1;/** Error message constants. */var FUNC_ERROR_TEXT$1='Expected a function';/* Built-in method references for those with the same name as other `lodash` methods. */var nativeMax=Math.max,nativeMin=Math.min;/**
...
function isEqual(val1,val2){return val1===val2||val1!==val1&&val2!==val2;}const get$1=()=>{try{const data=store.local.get(`storybook-layout`);return data||false;}catch(e){// eslint-disable-next-line no-console
console.error(e);return false;}};const write=memoizerific(1)(changes=>{try{store.local.set(`storybook-layout`,changes);}catch(e){// eslint-disable-next-line no-console
...
useEffect(()=>{const menuElement=document$5.getElementById('storybook-explorer-menu');// Even though we ignore repeated events, use throttle because IE doesn't support event.repeat.
...
const singleStoryComponentIds=useMemo(()=>{return orphansFirst.filter(nodeId=>{const{children=[],isComponent,isLeaf,name}=data[nodeId];return!isLeaf&&isComponent&&children.length===1&&isStory(data[children[0]])&&isStoryHoistable(data[children[0]].name,name);});},[data,orphansFirst]);// Omit single-story components from the list of nodes.
